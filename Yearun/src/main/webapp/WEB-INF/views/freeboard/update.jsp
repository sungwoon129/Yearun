...
<div class="currentaddress">
 ...
 <div class="allContents">
	...
	<input type="hidden" name="thumbnail" value="default" id="thum">
		<div class="freeTitle">
			<label>제목 &nbsp;&nbsp;</label> <input type="text" name="freeTitle" placeholder="게시글 제목을 입력해주세요." style="width:620px" value="${item.freeTitle}" onkeyup="chkword(this,40)">
	
		</div>
		<textarea name="freeContext" id="summernote">${item.freeContext}</textarea>
...
//                 $('#summernote').summernote("insertNode", img_name[0]);
			...
			<label for="input_file">파일 선택</label> 
                            <input class="upload-name" readonly="readonly" style="width: 200px;" value="${item.freePhotoA}">
