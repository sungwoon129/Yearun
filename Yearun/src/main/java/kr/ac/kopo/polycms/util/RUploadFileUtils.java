...
public class RUploadFileUtils {
	
	
	private static final Logger logger = LoggerFactory.getLogger(RUploadFileUtils.class);
	...
	public static String uploadFile(String uploadPath, String originalName, byte[] fileData) throws Exception {
		...
		//uploadedFile ame는 썸네일명으로 화면에 전달된다.
	...
	private static String makeThumbnail(String uploadPath, String path, String fileName) throws Exception {
		...
		BufferedImage destImg = Scalr.resize(cropImg, dw, dh);/*Scalr.Method.AUTOMATIC, Scalr.Mode.FIT_TO_HEIGHT, 100);*/
		...
		return OriginPath.substring(uploadPath.length()).replace(File.separatorChar, '/');
